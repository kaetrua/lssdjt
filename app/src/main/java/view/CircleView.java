...
public class CircleView extends View {
    ...
    private void init() {
        ...
        mPaint.setColor(getResources().getColor(R.color.pku_red));

        mStrokePaint=new Paint();
        mStrokePaint.setAntiAlias(true);
        mStrokePaint.setColor(getResources().getColor(R.color.pku_red));
        mStrokePaint.setStyle(Paint.Style.STROKE);
        mStrokePaint.setStrokeWidth(3);

        mDotLinePaint=new Paint();
        mDotLinePaint.setAntiAlias(true);
        mDotLinePaint.setColor(getResources().getColor(R.color.pku_red));
